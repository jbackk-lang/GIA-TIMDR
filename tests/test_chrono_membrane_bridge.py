...
core/chrono_membrane_bridge.py -- patrz docs/geometry/
PREREG_CHRONO_MEMBRANE_BEARING_v0.1.md. Kontrole syntetyczne (bramka
pozytywna/negatywna na pelnej siatce) sa w core/chrono_membrane_bridge.py
(uruchamiane jako skrypt, wzorem core/chrono_cone_bridge.py). Te testy
sprawdzaja WYLACZNIE elementarne wlasciwosci funkcji budujacych
